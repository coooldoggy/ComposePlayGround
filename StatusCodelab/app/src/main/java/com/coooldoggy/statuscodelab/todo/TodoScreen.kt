...
package com.coooldoggy.statuscodelab.todo
...
import com.codelabs.state.todo.TodoItemInputBackground
import com.coooldoggy.statuscodelab.util.generateRandomTodoItem
...
fun TodoRow(
    ...
    modifier: Modifier = Modifier, iconAlpha: Float = remember(todo.id) {
        randomTint()
    }
) {
    Row(
...
@Composable
fun TodoInputTextField(modifier: Modifier, text: String, onTextChange: (String) -> Unit) {
